...
public class RushMath extends GraphicsProgram
{
	...
	public void createStage()
	{
		...
		//A�adiendo campo de puntuaci�n.
		add(PUNT);		PUNT.setFilled(true);	PUNT.setFillColor(Color.GREEN);
		add(SCORE);
		//A�adiendo listeners necesarios.
		addMouseListeners();
		addKeyListeners();
		//A�adiendo campo de las preguntas.
	...
	private void GeneAD()
	{
		...
		question = new GLabel("�Cu�nto es " + a + " + " + b + "?");
		add(question, 73*CW / 100, 12*CH / 50);
	...
	GLabel question = new GLabel("�Cu�nto es " + A + " + " + B + "?");
